                ...
                <div className="flex h-full w-full items-center justify-center">
                    <div className="relative flex h-full w-full flex-col bg-white lg:h-5/6 lg:w-2/3 lg:rounded-3xl">
                        <button
                            type="button"
                            onClick={() => hideModal()}
                            className="absolute right-2 top-2 lg:right-3 lg:top-3 h-8 w-8 rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="currentColor"
