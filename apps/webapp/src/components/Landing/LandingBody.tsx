        ...
        <>
            <div className="bg-ll-grey p-5 flex flex-col items-center gap-5 pt-20 lg:py-24 max-w-6xl lg:gap-10">
                ...
                <div className="flex flex-col font-inter gap-5 lg:hidden">
                    ...
                    <Link href="/" className="bg-ll-yellow w-52 h-14 flex justify-center items-center rounded-full">
                        <span>Explore Experiences</span>
                    </Link>
                </div>
                ...
                <div className="flex flex-col font-inter gap-5 lg:hidden">
                    ...
                    <Link href="/host" className="bg-ll-yellow w-52 h-14 flex justify-center items-center rounded-full">
                        <span>Start Hosting</span>
                    </Link>
                </div>
