      ...
      <div className="flex min-h-screen flex-col">
        ...
        <div className="drawer drawer-end lg:drawer-open">
          ...
          <div className="drawer-side">
            ...
            />
            <div className="flex w-72 lg:w-96 flex-col items-center gap-3 bg-white p-3 pt-20 lg:pt-3 pb-20">
              <h1 className="text-3xl font-bold">Need help?</h1>
              <p>
                Thanks for creating an experience with Learned Local! Find the section below that you&apos;re currently working on and
                we&apos;ll give you some pointers!
              </p>
              <HelpMenuItem itemTitle="Step 1: Description" itemContent="The title and description of your experience are what give people their first impression of what your experience is about! Make sure to explain simply what the experience is and what people can hope to gain by attending." />
              <HelpMenuItem itemTitle="Step 2: Date & Time" itemContent="We recommend selecting a date that is at least several weeks in advance for hosting your experience. This will give people time to see your experience, decide whether they would like to go, and make room for it on their calendars. In addition, you can select multiple future dates for your experience; simply click on the dates in the calendar of when you would like to host your experience, and then enter the time for each date you've chosen."/>
              <HelpMenuItem itemTitle="Step 3: Location" itemContent="The most common place our hosts put on their experiences is in their own homes. However, if you need a larger space, consider reserving a community space. If you need help finding a location, don't hesitate to contact Learned Local for help!"/>
              <HelpMenuItem itemTitle="Step 4: Requirements" itemContent="Your guests will feel more comfortable if they know how to prepare for your experience. In the 'Provided Materials' field, list the tools or supplies that you'll be providing to your guests. In the location description field, list special instructions that the guests might need to follow to get to your location, such as going to a specific floor of a building, meeting at a trailhead, and so on. In the 'Guest Requirements' field, list everything your guests should do beforehand to be ready for the experience. You can also list things they need to bring, things they need to wear, and so on. In the 'Activity Level' field, you can list specific fitness requirements that your guests might need to meet, such as being able to carry heavy objects or walk for several hours. Finally, in the 'Skill Level' field, specify what kind of prior knowledge guests should have prior to participating in your experience. For example, they may need to have had practice using a welding torch before participating in your metal crafting experience." />
              <HelpMenuItem itemTitle="Step 5: Settings" itemContent="When pricing your experience, there are a few things to keep in mind. 1) How much time are you spending to prepare this experience? 2) How much are you spending on materials for this experience? 3) What are similar experiences on our site and in other places priced at? Unless your experience requires a lot of expensive equipment or materials, we would recommend pricing it between $20 and $50 per person" />
              <HelpMenuItem itemTitle="Step 6: Photos" itemContent="When uploading photos, try choosing photos that show the space you're hosting the experience in, an example of someone participating in your experience, or a finished product of something you'll make. The more photos you upload, the better." />
            </div>
          </div>
        </div>
        <Footer />
