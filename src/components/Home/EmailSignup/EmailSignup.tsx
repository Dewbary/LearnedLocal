...
const EmailSignup = () => {
  return (
    <CustomModal
      button={
        <div className="bg-gradient-to-br from-amber-400 to-amber-500 p-4 drop-shadow-md rounded-full fixed bottom-3 right-3 lg:bottom-10 lg:right-10 flex flex-row justify-center items-center gap-3 hover:cursor-pointer hover:from-amber-300 hover:to-amber-300">
