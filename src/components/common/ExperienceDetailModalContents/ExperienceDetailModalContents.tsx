    ...
    return (
        <>
            ...
            <div className="flex flex-row items-center justify-between bg-gradient-to-r from-amber-400 via-amber-200 to-white py-4 pr-6 pl-10 shadow-lg lg:rounded-t-3xl">
                <div className="flex w-full flex-col justify-between lg:flex-row lg:items-center">
                    <div className="flex flex-col">
                        <h1 className="text-2xl font-bold lg:text-4xl">{props.experienceInfo.title}</h1>
                        <p>
                            ...
                            <span className="inline-block">
                                ...
                                {props.experienceInfo.profile?.firstName} {props.experienceInfo.profile?.lastName}
                                </span>
                            </span>
                        </p>
                    </div>
                ...
                <div className="basis-full">
                    ...
                    <div className="mx-10 flex flex-col lg:flex-row">
                        ...
                        <div className="lg:order-0 order-2 mr-3 mb-3 basis-2/3">
                            ...
                            {props.experienceInfo.profile?.phone && <p>Phone: {props.experienceInfo.profile?.phone}</p>}
                        </div>
                        )}
            ...
            <div className="flex items-center justify-between border-t py-4 pl-6 pr-6">
                <div className="text-3xl font-bold">${props.experienceInfo.price}</div>
                    <button
                        className={
